...
namespace ET
{
    ...
    public class IdGenerater: IDisposable
    {
        ...
        {
            return (uint) ((Game.TimeInfo.FrameTime - epoch2020) / 1000);
        }

        private uint TimeSinceThisYear()
        {
            return (uint) ((Game.TimeInfo.FrameTime - instanceIdEpoch) / 1000);
        }
        ...
        public long GenerateInstanceId()
        {
            ...
            if (instanceIdThisSecCount > Mask18bit - 1)
            {
            ...
            InstanceIdStruct instanceIdStruct = new InstanceIdStruct(time, Game.Options.Process, instanceIdValue);
        ...
        public long GenerateUnitId(int zone)
        {
            ...
            UnitIdStruct unitIdStruct = new UnitIdStruct(zone, Game.Options.Process, time, unitIdValue);
