...
namespace Pathfinding.Examples
{
    ...
    public class RVOExampleAgent: MonoBehaviour
    {
        ...
        private System.Collections.IEnumerator AnimateColor(MeshRenderer rend, Color startColor, Color endColor)
        {
            float t = 0;
        ...
        public void Update()
        {
            ...
            if (vectorPath != null && vectorPath.Count != 0)
            {
                ...
                var t = VectorMath.LineCircleIntersectionFactor(controller.To2D(transform.position), controller.To2D(p1), controller.To2D(p2),
                    moveNextDist);
