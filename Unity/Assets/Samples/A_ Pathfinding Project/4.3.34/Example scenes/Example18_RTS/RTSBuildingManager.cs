                ...
                for (int z = touchingTiles.ymin; z <= touchingTiles.ymax; z++)
                {
                    ...
                    for (int i = 0; i < tile.nodes.Length; i++)
                    {
                        ...
                        for (int j = 0; j < node.connections.Length; j++)
                        {
                            ...
                            if (conn.shapeEdge >= 0 && conn.shapeEdge < 3)
                            {
                                usedSides[conn.shapeEdge] = true;
                            }
                        }
                        ...
                        for (int j = 0; j < 3; j++)
                        {
                            if (!usedSides[j])
                            {
                                ...
                                {
                                    if (Polygon.ContainsPointXZ(contourArrays[k], segmentStart) ||
                                        Polygon.ContainsPointXZ(contourArrays[k], segmentEnd))
                                    {
