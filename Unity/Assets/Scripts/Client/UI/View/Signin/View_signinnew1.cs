...
namespace UI.Story.Signin
{
    public partial class View_signinnew1: GComponent
    {
        ...
        public override void ConstructFromXML(XML xml)
        {
            ...
            Day1 = (View_SigninComponent) GetChildAt(8);
            Day2 = (View_SigninComponent) GetChildAt(9);
            Day3 = (View_SigninComponent) GetChildAt(10);
            Day4 = (View_SigninComponent) GetChildAt(11);
            Day5 = (View_SigninComponent) GetChildAt(12);
            Day6 = (View_SigninComponent) GetChildAt(13);
            Day7 = (View_SigninComponent) GetChildAt(14);
            Title = (GTextField) GetChildAt(19);
            Close = (GButton) GetChildAt(20);
            Receive = (GButton) GetChildAt(21);
        }
    }
}