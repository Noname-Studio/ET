...
namespace UI.Story.BeginCG
{
	public partial class View_BeginCG : GComponent
	{
		...
		public override void ConstructFromXML(XML xml)
		{
			...
			sence1 = (GGroup)this.GetChildAt(9);
			sence2 = (GGroup)this.GetChildAt(20);
			sence3 = (GGroup)this.GetChildAt(28);
			sence1_2 = this.GetTransitionAt(0);
			sence2_2 = this.GetTransitionAt(1);
			sence3_2 = this.GetTransitionAt(2);
		}
	}
}