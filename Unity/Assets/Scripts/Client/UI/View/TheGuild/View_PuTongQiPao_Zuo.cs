...
namespace TheGuild
{
    public partial class View_PuTongQiPao_Zuo : GComponent
    {
        ...
        public static View_PuTongQiPao_Zuo CreateInstance()
        {
            return (View_PuTongQiPao_Zuo)UIPackage.CreateObject("TheGuild", "普通气泡_左");
        }
