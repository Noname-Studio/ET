...
namespace TheGuild
{
    public class TheGuildBinder
    {
        [UnityEngine.RuntimeInitializeOnLoadMethod(UnityEngine.RuntimeInitializeLoadType.BeforeSceneLoad)]
        public static void BindAll()
        {
            UIObjectFactory.SetPackageItemExtension(View_GongHuiYaoQingLieBiao.URL, typeof(View_GongHuiYaoQingLieBiao));
            UIObjectFactory.SetPackageItemExtension(View_UnionMainPanel.URL, typeof(View_UnionMainPanel));
            UIObjectFactory.SetPackageItemExtension(View_HuiZhangZhiZuo.URL, typeof(View_HuiZhangZhiZuo));
            UIObjectFactory.SetPackageItemExtension(View_DianJiFanKui.URL, typeof(View_DianJiFanKui));
            UIObjectFactory.SetPackageItemExtension(View_Member.URL, typeof(View_Member));
            UIObjectFactory.SetPackageItemExtension(View_HaoYouXuanZe_Button.URL, typeof(View_HaoYouXuanZe_Button));
            UIObjectFactory.SetPackageItemExtension(View_HaoYouBangZhuZuJian.URL, typeof(View_HaoYouBangZhuZuJian));
            UIObjectFactory.SetPackageItemExtension(View_GongHuiXiangQing.URL, typeof(View_GongHuiXiangQing));
            UIObjectFactory.SetPackageItemExtension(View_GongHuiChengYuanZuJian.URL, typeof(View_GongHuiChengYuanZuJian));
            UIObjectFactory.SetPackageItemExtension(View_GongHuiChengYuanChaKan.URL, typeof(View_GongHuiChengYuanChaKan));
            UIObjectFactory.SetPackageItemExtension(View_GongHuiTuiChu.URL, typeof(View_GongHuiTuiChu));
            UIObjectFactory.SetPackageItemExtension(View_BiaoQingBao.URL, typeof(View_BiaoQingBao));
            UIObjectFactory.SetPackageItemExtension(View_Component1.URL, typeof(View_Component1));
            UIObjectFactory.SetPackageItemExtension(View_juesepaiming.URL, typeof(View_juesepaiming));
            ...
            UIObjectFactory.SetPackageItemExtension(View_GongHuiHuoDongShuoMing.URL, typeof(View_GongHuiHuoDongShuoMing));
            UIObjectFactory.SetPackageItemExtension(View_JiangLiXiangQing.URL, typeof(View_JiangLiXiangQing));
            UIObjectFactory.SetPackageItemExtension(View_ShenQingZuJian.URL, typeof(View_ShenQingZuJian));
            ...
            UIObjectFactory.SetPackageItemExtension(View_JiaoSeMoXingZu.URL, typeof(View_JiaoSeMoXingZu));
        }
    }
}