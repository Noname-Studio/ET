...
namespace UI.Story.Map
{
	public partial class View_Map : GComponent
	{
		...
		public override void ConstructFromXML(XML xml)
		{
			...
			Close = (GButton)this.GetChildAt(2);
			rest1 = (View_coordinates_button)this.GetChildAt(5);
			rest2 = (View_coordinates_button)this.GetChildAt(6);
			rest3 = (View_coordinates_button)this.GetChildAt(7);
		}
	}
}