...
{              
    /*[Key(5)]*/ public Data_Food_Info Avocado_Bacon { get; set; }
    /*[Key(6)]*/ public Data_Food_Info Bacon { get; set; }
    /*[Key(7)]*/ public Data_Food_Info Bacon_Benedict_egg { get; set; }
    /*[Key(8)]*/ public Data_Food_Info Bacon_Sandwiches { get; set; }
    /*[Key(9)]*/ public Data_Food_Info Baked_Potato { get; set; }
    /*[Key(10)]*/ public Data_Food_Info Black_Coffee { get; set; }
    /*[Key(11)]*/ public Data_Food_Info Caesar_Salad { get; set; }
    /*[Key(12)]*/ public Data_Food_Info ClamSoup { get; set; }
    /*[Key(13)]*/ public Data_Food_Info Fried_Broccoli { get; set; }
    /*[Key(14)]*/ public Data_Food_Info Fried_Eggs { get; set; }
    /*[Key(15)]*/ public Data_Food_Info Fried_Steak { get; set; }
    /*[Key(16)]*/ public Data_Food_Info Iced_Coffee { get; set; }
    /*[Key(17)]*/ public Data_Food_Info Lobster_Soup { get; set; }
    /*[Key(18)]*/ public Data_Food_Info Milkshake { get; set; }
    /*[Key(19)]*/ public Data_Food_Info Muffin { get; set; }
    /*[Key(20)]*/ public Data_Food_Info Omelette { get; set; }
    /*[Key(21)]*/ public Data_Food_Info Poached_egg { get; set; }
    /*[Key(22)]*/ public Data_Food_Info Raw_Chips { get; set; }
    /*[Key(23)]*/ public Data_Food_Info Roasted_Asparagus { get; set; }
    /*[Key(24)]*/ public Data_Food_Info Roasted_Tomatoes { get; set; }
    /*[Key(25)]*/ public Data_Food_Info Steak_Sandwich { get; set; }
    /*[Key(26)]*/ public Data_Food_Info Steak_With_Broccoli { get; set; }
    /*[Key(27)]*/ public Data_Food_Info Steak_With_Tamato { get; set; }
    /*[Key(28)]*/ public Data_Food_Info Toast { get; set; }
    /*[Key(29)]*/ public Data_Food_Info Tomato_Benedict_egg { get; set; }
    ...
    public Data_Food_Breakfast()
    {
         ...
         GetMappings.Add("Muffin", (t) => t.Muffin ?? (t.Muffin = new Data_Food_Info()));
         ...
         SetMappings.Add("Muffin", (t1, t2) => t1.Muffin = t2);
