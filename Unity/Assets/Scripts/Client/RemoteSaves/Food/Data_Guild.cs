...
public class Data_Guild : DBDefine
{
    ...
    [ProtoMember(11)] public List<MemberInfo> Members = new List<MemberInfo>();
    [ProtoMember(12)] public List<ApplicationInfo> ApplicationList = new List<ApplicationInfo>();
    [ProtoMember(13)] public uint CreateTime;
}