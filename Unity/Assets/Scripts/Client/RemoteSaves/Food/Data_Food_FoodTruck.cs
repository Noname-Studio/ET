...
{              
    /*[Key(5)]*/ public Data_Food_Info BurnedFood { get; set; }

    private Dictionary<string, Func<Data_Food_FoodTruck,Data_Food_Info>> GetMappings = new Dictionary<string, Func<Data_Food_FoodTruck,Data_Food_Info>>();
    private Dictionary<string, Action<Data_Food_FoodTruck,Data_Food_Info>> SetMappings = new Dictionary<string, Action<Data_Food_FoodTruck,Data_Food_Info>>();
