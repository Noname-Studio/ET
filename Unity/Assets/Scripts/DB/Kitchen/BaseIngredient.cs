...
#if UNITY_EDITOR
    [SerializeField,HideLabel,PreviewField(55,ObjectFieldAlignment.Left),DisableInInlineEditors,OnValueChanged("SetTexture")]
    protected Texture mEditorTexture; // 纹理名称
#endif
    [SerializeField, LabelText("Key"),HideInInlineEditors,ReadOnly,VerticalGroup("基础信息/Split/Right")]
