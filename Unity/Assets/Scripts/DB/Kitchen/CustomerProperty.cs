...
public partial class CustomerProperty : SerializedScriptableObject
{
    ...
    [SerializeField, LabelText("Key"),HideInInlineEditors,ReadOnly,VerticalGroup("设定/Split/Normal/Right")]
    string mKey;                                   // 顾客名字键值
    [SerializeField, LabelText("顾客类型"),HideInInlineEditors,VerticalGroup("设定/Split/Normal/Right"),ValueDropdown("EDITOR_CustomerType")]
    CustomerType mType;                                  // 类型
    
    #if UNITY_EDITOR
    [FormerlySerializedAs("mIconTexture")] [SerializeField, PreviewField(55,ObjectFieldAlignment.Left),DisableInInlineEditors,HideLabel,VerticalGroup("设定/Split/Normal/Left"),PropertyOrder(-100)]
    Texture mEditorTexture;                           // 图标材质
    #endif
