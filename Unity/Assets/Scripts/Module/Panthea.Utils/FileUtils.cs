...
namespace Module.Panthea.Utils
{
    public static class FileUtils
    {
        ...
        private static byte[] AesKey256 { get; } = {161,36,168,189,234,133,73,189,21,60,168,29,186,216,240,6,73,255,34,203,86,90,103,237,221,147,136,228,245,26,245,65};
        private static AesCryptoServiceProvider Aes { get; } = new AesCryptoServiceProvider { BlockSize = 128, KeySize = 256, Key = AesKey256, IV = AesIV256 };
