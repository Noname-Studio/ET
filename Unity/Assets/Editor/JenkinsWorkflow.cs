...
//
	...
	public static void CommandLineBuildIPA(CommandParams args)
	{
		...
		if (EditorUserBuildSettings.SwitchActiveBuildTarget(BuildTargetGroup.iOS, BuildTarget.iOS))
		{
			...
			//生成苹果项目
			BuildPipeline.BuildPlayer(GetBuildScenes(), exportPath, BuildTarget.iOS,BuildOptions.AcceptExternalModificationsToPlayer | BuildOptions.CompressWithLz4HC | BuildOptions.Development);
