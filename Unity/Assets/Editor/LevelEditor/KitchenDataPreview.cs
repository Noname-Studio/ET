...
[CustomEditor(typeof(FoodProperty)),CanEditMultipleObjects]
public class FoodPreview : MyPreview
{
    public override Type Type
    {
        get { return typeof(FoodProperty); }
    }
}

[CustomEditor(typeof(IngredientProperty)),CanEditMultipleObjects]
public class IngredientPreview : MyPreview
{
    public override Type Type
    {
        get { return typeof(IngredientProperty); }
    }
}

[CustomEditor(typeof(CustomerProperty)),CanEditMultipleObjects]
public class CustomerPreview : MyPreview
{
    public override Type Type
    {
        get { return typeof(CustomerProperty); }
    }
}

[CustomEditor(typeof(CookwareProperty)),CanEditMultipleObjects]
public class CookwarePreview : MyPreview
{
    public override Type Type
    {
        get { return typeof(CookwareProperty); }
    }
}